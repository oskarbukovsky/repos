                ...
                while (true)
                {
                    ...
                    if (tmp != null)
                    {
                        ...
                        else
                        {
                            ...
                            Console.WriteLine("BB:" + String.Join(", ", KnownHosts.Host.Where(host => host.Hostname == tmp.Hostname).First().ValidTokens) +
                                "\nCC:" + KnownHosts.Host.Where(host => host.Hostname == tmp.Hostname).First().Hostname);
                        }
                        foreach (var i in KnownHosts.Host.Where(host => host.Hostname == tmp.Hostname))
                        {
                            Console.WriteLine("DD:" + i.Hostname);
                        }
